...
import 'dart:io';
import 'package:cod_squad_app/screens/onboarding/onboarding_flow.dart';
import 'package:cod_squad_app/screens/onboarding/profile_setup_screen.dart';
import 'package:cod_squad_app/screens/add_game_screen.dart';
import 'package:cod_squad_app/services/onboarding_service.dart';
import 'package:cod_squad_app/providers/user_notifier.dart';
import 'package:cod_squad_app/providers/game_notifier.dart';
import 'package:cod_squad_app/providers/system_notifier.dart';
import 'package:cod_squad_app/chat/squads_screen.dart';
import 'package:cod_squad_app/services/app_flow_manager.dart';
...
void main() {
  ...
  group('OnboardingFlow Widget Tests', () {
    ...
    testWidgets('completes onboarding and navigates to SquadsScreen',
        (tester) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
      ...
      expect(find.byType(SquadsScreen), findsOneWidget);
