...
class LobbySheet extends ConsumerWidget {
  const LobbySheet({super.key});
  ...
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const LobbySheet(),
    );
  }
  ...
  Widget _buildActiveSpotsSection(LobbyState squadState) {
    final activeGames = squadState.availableGames.where((game) {
      final spots = squadState.gameLobbySpots[game['name']] ?? [];
  ...
  Widget _buildRosterSection(LobbyState squadState) {
    final members = squadState.lobbyMemberUids
