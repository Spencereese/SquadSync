...
/// @nodoc
mixin _$UserState {
  AppUser? get profile => throw _privateConstructorUsedError;
  Map<String, String> get displayNames => throw _privateConstructorUsedError;
  List<String> get blockedUsers => throw _privateConstructorUsedError;
  Map<String, double> get ratings => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      profile: freezed == profile
          ...
          : profile // ignore: cast_nullable_to_non_nullable
              as AppUser?,
      displayNames: null == displayNames
          ? _value.displayNames
...
class _$UserStateImpl implements _UserState {
  const _$UserStateImpl(
      {this.profile,
      required final Map<String, String> displayNames,
      required final List<String> blockedUsers,
      required final Map<String, double> ratings})
  ...
  @override
  Map<String, String> get displayNames {
    if (_displayNames is EqualUnmodifiableMapView) return _displayNames;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_displayNames);
  }
  ...
  @override
  String toString() {
    return 'UserState(profile: $profile, displayNames: $displayNames, blockedUsers: $blockedUsers, ratings: $ratings)';
  }
...
abstract class _UserState implements UserState {
  const factory _UserState(
      ...
      required final Map<String, String> displayNames,
      required final List<String> blockedUsers,
      required final Map<String, double> ratings}) = _$UserStateImpl;
