...
void main() {
  ...
  group('SettingsTab Widget Tests', () {
    testWidgets('should display settings UI elements', (WidgetTester tester) async {
      // Arrange
    ...
    testWidgets('should show theme mode switches', (WidgetTester tester) async {
      ...
      // Assert
      expect(find.byType(Switch), findsNWidgets(3)); // Theme, Notifications, Sound switches
      expect(find.text('System'), findsOneWidget);
      expect(find.text('Light'), findsOneWidget);
      expect(find.text('Dark'), findsOneWidget);
    });

    testWidgets('should toggle theme mode when switch is tapped', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
    ...
    testWidgets('should toggle notifications switch', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
      when(mockRepository.setNotificationsEnabled(false)).thenAnswer((_) async => null);
      ...
      final notificationsSwitch = find.byType(Switch).at(0); // First switch is notifications
    ...
    testWidgets('should toggle vibration switch', (WidgetTester tester) async {
      ...
      final vibrationSwitch = find.byType(Switch).at(2); // Third switch is vibration
    ...
    testWidgets('should show snackbar on theme change success', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
      when(mockRepository.setThemeMode(ThemeMode.light)).thenAnswer((_) async => null);
    ...
    testWidgets('should show snackbar on theme change failure', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
      when(mockRepository.setThemeMode(ThemeMode.light)).thenThrow(Exception('Theme update failed'));
    ...
    testWidgets('should show snackbar on notifications toggle success', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
    ...
    testWidgets('should show snackbar on notifications toggle failure', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
      when(mockRepository.setNotificationsEnabled(true)).thenThrow(Exception('Notifications update failed'));
    ...
    testWidgets('should request notification permissions when enabling notifications', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
    ...
    testWidgets('should show permissions denied message when permissions are rejected', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
    ...
    testWidgets('should display current system state values', (WidgetTester tester) async {
      // Arrange
      final systemNotifier = SystemNotifier(test_injection.getIt);
