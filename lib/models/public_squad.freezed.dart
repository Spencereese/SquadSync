...
PublicSquad _$PublicSquadFromJson(Map<String, dynamic> json) {
  return _PublicSquad.fromJson(json);
}
...
mixin _$PublicSquad {
  ...
  /// Serializes this PublicSquad to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PublicSquad
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PublicSquadCopyWith<PublicSquad> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PublicSquadCopyWith<$Res> {
  factory $PublicSquadCopyWith(
          PublicSquad value, $Res Function(PublicSquad) then) =
      _$PublicSquadCopyWithImpl<$Res, PublicSquad>;
  @useResult
  $Res call(
      {String id,
      String name,
...
/// @nodoc
class _$PublicSquadCopyWithImpl<$Res, $Val extends PublicSquad>
    implements $PublicSquadCopyWith<$Res> {
  _$PublicSquadCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PublicSquadImplCopyWith<$Res>
    implements $PublicSquadCopyWith<$Res> {
  factory _$$PublicSquadImplCopyWith(
          _$PublicSquadImpl value, $Res Function(_$PublicSquadImpl) then) =
      __$$PublicSquadImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$PublicSquadImplCopyWithImpl<$Res>
    extends _$PublicSquadCopyWithImpl<$Res, _$PublicSquadImpl>
    implements _$$PublicSquadImplCopyWith<$Res> {
  __$$PublicSquadImplCopyWithImpl(
      _$PublicSquadImpl _value, $Res Function(_$PublicSquadImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PublicSquadImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$PublicSquadImpl implements _PublicSquad {
  const _$PublicSquadImpl(
      {required this.id,
      required this.name,
      this.primaryGameId,
  ...
  factory _$PublicSquadImpl.fromJson(Map<String, dynamic> json) =>
      _$$PublicSquadImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PublicSquadImplCopyWith<_$PublicSquadImpl> get copyWith =>
      __$$PublicSquadImplCopyWithImpl<_$PublicSquadImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PublicSquadImplToJson(
      this,
    );
  }
}

abstract class _PublicSquad implements PublicSquad {
  const factory _PublicSquad(
      ...
      final DateTime? bumpTimestamp}) = _$PublicSquadImpl;

  factory _PublicSquad.fromJson(Map<String, dynamic> json) =
      _$PublicSquadImpl.fromJson;
