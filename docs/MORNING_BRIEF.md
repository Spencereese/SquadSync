...
1. Tip `9c95267` / **3.4.138+140**. Product tip is Red A (`186215c`). Burst B docs/code sit on the same version line; `pubspec.yaml` was not bumped.
...
6. Next slice card: none overnight. Optional Harness widen CI to fire on the revive branch (docs-only workflow `on:`) — park for Spencer **yes**.
