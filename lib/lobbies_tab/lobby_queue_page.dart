...
class LobbyQueuePage extends ConsumerStatefulWidget {
  const LobbyQueuePage({super.key});

  @override
  ConsumerState<LobbyQueuePage> createState() => LobbyQueuePageState();
}

class LobbyQueuePageState extends ConsumerState<LobbyQueuePage>
